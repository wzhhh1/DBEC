...
import com.example.DBEC.entity.month;
...
@WebServlet(name = "Echart4Servlet", value = "/Echart4Servlet")
public class Echart4Servlet extends HttpServlet {
    @Override
...
// 数据添加到集合里面，获取sql数据信息，然后转为json字符串，然后存到list中。
        ...
        System.out.println("Echarts-post请求收到");
        request.setCharacterEncoding("utf-8");

        HistogramService service = new HistogramServiceImpl();
        List<month> list = service.findMonth();
