...
import com.example.DBEC.entity.Piechart3;
...
@WebServlet(name = "PiechartServlet3", value = "/PiechartServlet3")
public class PiechartServlet3 extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Piechart3> list = service.findPriceSegment();
